# NovaMotion - AI Video Generation Platform

## Project Overview

NovaMotion is a SaaS platform for AI-powered video generation. It's built as a standalone Next.js application with AI video generation capabilities.
