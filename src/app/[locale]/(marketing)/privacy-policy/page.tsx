    ...
    return (
        <div className="container mx-auto px-4 py-12 max-w-4xl">
            ...
            <div className="prose dark:prose-invert">
                ...
                <p>Welcome to NovaMotion. We respect your privacy and are committed to protecting your personal data.</p>
                ...
                <h2>5. Contact Us</h2>
                <p>If you have questions about this policy, please contact us at {settings.supportEmail || "Not configured"}.</p>
            </div>
        </div>
    );
}
