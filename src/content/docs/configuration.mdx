...
description: How to configure pricing, credits, AI models, and admin access in NovaMotion.
---

# Configuration Guide

This guide explains how to configure pricing, credits, AI models, and admin access in NovaMotion.
